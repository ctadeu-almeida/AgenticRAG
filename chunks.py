class Chunks:
    def __init__(self, chunk_size=1000, overlap_size=200):
        """
        Inicializa a classe Chunks.
        
        Args:
            chunk_size (int): Tamanho máximo de cada chunk em caracteres
            overlap_size (int): Tamanho da sobreposição entre chunks em caracteres
        """
    ...
    def create_chunks(self, text):
        """
        Cria chunks do texto fornecido.
        
        Args:
            text (str): Texto a ser dividido em chunks
            
        Returns:
            list: Lista de strings contendo os chunks
        """
    ...
    def create_chunks_with_metadata(self, text, source_info=None):
        """
        Cria chunks com metadados adicionais.
        
        Args:
            text (str): Texto a ser dividido em chunks
            source_info (dict): Informações sobre a fonte do texto
            
        Returns:
            list: Lista de dicionários contendo chunks e metadados
        """
    ...
    def _calculate_start_position(self, chunks, chunk_index):
        """
        Calcula a posição aproximada de início do chunk no texto original.
        ...
        Returns:
            int: Posição aproximada de início
        """
        if chunk_index == 0:
            return 0
    ...
    def get_chunk_info(self):
        """
        Retorna informações sobre a configuração atual dos chunks.
        
        Returns:
            dict: Informações sobre chunk_size e overlap_size
        """
        return {
    ...
    def update_settings(self, chunk_size=None, overlap_size=None):
        """
        Atualiza as configurações de chunk_size e/ou overlap_size.
        
        Args:
            chunk_size (int, optional): Novo tamanho do chunk
            overlap_size (int, optional): Novo tamanho do overlay
        """
